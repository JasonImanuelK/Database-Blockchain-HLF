...
class AssetWorkload extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        ...
        const buyAssetArgs = {
            ...
            contractArguments: [assetID, '200', 'Ventela', `AssetName${this.txIndex}`, '2000', 'LocationAaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'In Plant', '2024-05-05'],
            readOnly: false
        };
